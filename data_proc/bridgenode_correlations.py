...
def make_correlation_table(correlation_dict):
    ...
    for lv in range(1, 11):
        ...
        print(line_2)
    print("\\end{tabular}")
    print("\\caption[Pearson's correlation between $TDC$ and $\overline{TG}_L$]{Pearson's correlation between $TDC$ and $\overline{TG}_L$ for each model $m$, space $s$, and logic network version $q$.}")
    print("\\label{tab:bn_correlations}")
    print("\\end{table}")
        ...
        for lv in range(1, 11):
            ...
            for space in [(20, 500), (100, 100)]:
                ...
                for ndep in list(range(1, 11)):
                    ...
                    lvs, curves_as_p = dp.get_curves_as_points(lv, interlink_type, interlink_version, model, ndep, space, strategy, legacy=False, m_results=False, add_to_title=prefix)
...
list_dict_2 = {(20, 500): [[9, 7], [9, 7], [9, 7], [9, 7], [9, 7], [9, 7],
                           [4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7],
                           [8, 7], [8, 7], [8, 7], [8, 7], [8, 7], [8, 7],
                           [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7],
                           [7], [7], [7], [7], [7], [7],
                           [8, 10, 4, 6], [8, 10, 4, 6], [8, 4, 6], [8, 4, 6], [8, 4, 6], [8, 4, 6],
                           [9, 5], [9, 5], [9, 5], [9, 5], [9, 5], [9, 5],
                           [3, 7], [3, 7], [3, 7], [3, 7], [3, 7], [3, 7],
                           [8, 10, 4], [8, 10, 4], [8, 10, 4], [8, 10, 4], [8, 10, 4], [8, 10, 4],
                           [7], [7], [7], [7], [7], [7]],
               (100, 100): [[9, 7], [9, 7], [9, 7], [9, 7], [9, 7], [9, 7],
                            [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7],
                            [8, 7], [8, 7], [8, 7], [8, 7], [8, 7], [8, 7],
                            [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7], [9, 4, 7],
                            [7], [7], [7], [7], [7], [7],
                            [8, 4, 6], [8, 4, 6], [8, 4, 6], [8, 4, 6], [8, 4, 6], [8, 10, 4, 6],
                            [9, 5], [9, 5], [9, 5], [9, 5], [9, 5], [9, 5],
                            [3, 7], [3, 7], [9, 3, 7], [3, 7], [3, 7], [3, 7],
                            [8, 10, 4], [8, 10, 4], [8, 10, 4], [8, 10, 4], [8, 10, 4], [8, 10, 4],
                            [7], [7], [7], [7], [7], [7]],
               (0, 0): [[7], [7], [7], [7], [7], [7],
                        [8], [8], [7], [8], [8], [8],
